...
export default function Trustees() {
  ...
  return (
    <div className=" border border-gray-500 rounded-xl py-12 px-6 md:px-16 lg:px-24">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-center mt-6 md:mt-12">
